...
class DienNuocController extends Controller
{
    ...
    public function danhsachdiennuoc(Request $request) {
		...
		// foreach($diennuoc as $key => $value) {
		// 	if()
		// }


    	return view('admin.diennuoc.danhsachdiennuoc', ['diennuoc'=>$diennuoc]);
    }
...
//----------------------------------------------------------------------
    	...
    	return redirect('admin/diennuoc/')->with('notification', 'Nhập số điện nước thành công !');
    }
    ...
    public function postSua(Request $request, $id) {
    	...
    	return redirect('admin/diennuoc/')->with('notification', 'Sửa thông tin điện nước thành công !');
    ...
    public function getXoa($id) {
    	$dn = DienNuoc::find($id);
    	$dn->delete();
    	return redirect('admin/diennuoc/')->with('notification', 'Xóa thông tin điện nước thành công');
    }
}
