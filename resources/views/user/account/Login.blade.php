...
<body>
	<div>
		<h3 class="sub-tieude" style="color: black;">ĐĂNG NHẬP NGƯỜI DÙNG</h3>
		<div class="form">
			@if(count($errors)>0) 
			...
			<form action="{{ url('dangnhapnguoidung') }}" method="post">
				@csrf
				<div class="row">
					<div class="col-md-4">
				...
				<div style="margin-left: 130px; margin-bottom: ">
					<input class="btn btn-primary" type="submit" name="dangki" value="Đăng nhập" style="width: 100px;">
